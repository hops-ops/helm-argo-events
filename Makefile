...
PACKAGE ?= helm-argo-events
XRD_DIR := apis/argoevents
COMPOSITION := $(XRD_DIR)/composition.yaml
DEFINITION := $(XRD_DIR)/definition.yaml
EXAMPLE_DEFAULT := examples/argoevents/standard.yaml
...
EXAMPLES := \
    examples/argoevents/minimal.yaml:: \
    examples/argoevents/standard.yaml::
...
render\:%:
	@example="examples/argoevents/$*.yaml"; \
	up composition render --xrd=$(DEFINITION) $(COMPOSITION) $$example
